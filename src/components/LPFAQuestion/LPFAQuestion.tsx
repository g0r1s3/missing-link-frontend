...
export default function LPFAQuestion({
    ...
    return (
        <details
            ...
            {...(id ? { id } : null)}
        >
            <summary className="ml-faq__summary">
                <span className="ml-faq__q">{question}</span>
                <span
                    className="ml-faq__icon"
                    aria-hidden="true"
                />
            </summary>
            <div className="ml-faq__panel">
                <div className="ml-faq__a">{answer}</div>
            </div>
        </details>
    )
}