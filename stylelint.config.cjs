...
module.exports = {
  ...
  overrides: [
    // 2a) Nur in der Theme-Datei: strenge Namens-Pattern
    {
      files: ["src/styles/theme.css"],
      rules: {
        "custom-property-pattern":
          "^(--color-[a-z0-9-]+|--space-[a-z0-9-]+|--radius-[a-z0-9-]+|--shadow-[0-9]+|--panel-(bg|text|border|shadow)|--surface|--on-surface|--on-accent|--border-color(-strong)?|--focus-ring|--input-(bg|text|border|border-hover|border-focus|shadow-focus|placeholder)|--btn-primary-(bg|bg-active|text)|--link(-hover)?)$"
      }
    },
    // 2b) In ALLEN anderen Dateien: Pattern-Prüfung deaktivieren
    {
      files: ["**/*.css", "**/*.scss"],
